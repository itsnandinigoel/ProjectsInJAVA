...
public class Sprite {
    ...
    // The display image for the sprite
     ...
     *
     * @param imgPath String representing the file path
     */
    ...
    public boolean isColliding(Sprite other) {
        // See if this rectangle is right of other
        return (yPosition + size >= other.yPosition) // See if this rectangle is above other
    ...
    public boolean isCollidingPoint(int x, int y) {
        return x >= xPosition && x <= xPosition + size && // within x range
